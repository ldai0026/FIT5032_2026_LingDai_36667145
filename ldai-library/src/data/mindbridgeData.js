export const resourceRows = [
  ...
  },
  {
    ...
    type: 'Self-help',
    topic: 'Sleep and wellbeing',
    audience: 'Young adults',
    status: 'Published',
    description: 'Small, practical routines for rebuilding a healthier sleep pattern.',
  },
  {
    id: 'workplace-support-guide',
    title: 'Workplace support conversation guide',
    type: 'Carer guide',
    topic: 'Workplace wellbeing',
    audience: 'Carers',
    status: 'Review',
    description: 'Prompts for discussing reasonable support with a manager or colleague.',
  },
  {
    id: 'mindfulness-audio-list',
    title: 'Mindfulness audio collection',
    type: 'Self-help',
    topic: 'Stress',
    audience: 'All users',
    status: 'Published',
    description: 'A curated list of short, accessible mindfulness exercises.',
  },
  {
    id: 'youth-referral-checklist',
    title: 'Youth referral checklist',
    type: 'Staff resource',
    topic: 'Referral',
    audience: 'Staff',
    status: 'Published',
    description: 'A checklist for recording consent, urgency, and suitable referral pathways.',
  },
  {
    id: 'community-connection-list',
    title: 'Community connection directory',
    type: 'Peer support',
    topic: 'Community',
    audience: 'Members',
    status: 'Published',
    description: 'Local activities and moderated groups that can reduce isolation.',
  },
  {
    id: 'exam-stress-toolkit',
    title: 'Exam stress toolkit',
    type: 'Self-help',
    topic: 'Study wellbeing',
    audience: 'Students',
    status: 'Published',
    description: 'Grounding exercises and planning prompts for assessment periods.',
  },
  {
    id: 'crisis-contact-card',
    title: 'Crisis contact card',
    type: 'Safety plan',
    topic: 'Crisis preparation',
    audience: 'All users',
    status: 'Published',
    description: 'A printable card for trusted contacts and urgent support options.',
  },
]
...
export const outreachRows = [
  ...
  { id: 'oc-006', name: 'Sofia Nguyen', email: 'sofia@example.org', pathway: 'Counselling', status: 'New', lastContact: '2026-07-28' },
  { id: 'oc-007', name: 'Ethan Brown', email: 'ethan@example.org', pathway: 'Peer support', status: 'Scheduled', lastContact: '2026-07-27' },
  { id: 'oc-008', name: 'Grace Wilson', email: 'grace@example.org', pathway: 'Carer guide', status: 'Follow-up due', lastContact: '2026-07-26' },
  { id: 'oc-009', name: 'Noah Taylor', email: 'noah@example.org', pathway: 'Referral', status: 'New', lastContact: '2026-07-25' },
  { id: 'oc-010', name: 'Ava Martin', email: 'ava@example.org', pathway: 'Safety plan', status: 'Scheduled', lastContact: '2026-07-24' },
  { id: 'oc-011', name: 'Oliver Davis', email: 'oliver@example.org', pathway: 'Counselling', status: 'Follow-up due', lastContact: '2026-07-23' },
  { id: 'oc-012', name: 'Mia Anderson', email: 'mia@example.org', pathway: 'Peer support', status: 'New', lastContact: '2026-07-22' },
]
